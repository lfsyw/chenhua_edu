...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-2 text-right p-t-10">
            <a class="btn btn-info btn-md" href="{{route('admin.common.ad.index')}}">广告列表</a>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="POST" class="form-horizontal" action="{{route('admin.common.ad.store')}}">
                            {{csrf_field()}}
                            @include('admin.common.ad._form')
                        </form>

            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="POST" class="form-horizontal" action="{{route('admin.common.option.update',['id'=>$field->id])}}">
                            {{method_field('PUT')}}
                            {{csrf_field()}}
...
@section('footer')
    ...
    @include('admin.includes._delete',[
        'beseUrl'=>route('admin.common.option.index'),
        'jumpUrl'=>route('admin.common.option.index')
    ])
@endsection